...
-(NSDictionary *)getAllPropertiesAndValues {
    ...
    //属性的链表
    objc_property_t *properties =class_copyPropertyList([_object class], &outCount);
    //遍历链表
...
- (NSArray *)getAllProperties
{
    unsigned int count;
    //获取属性的链表
    objc_property_t *properties  =class_copyPropertyList([_object class], &count);
...
-(NSArray *)getAllMethods
{
    ...
    //获取方法链表
    Method* methodList_f = class_copyMethodList([_object class],&count_f);
